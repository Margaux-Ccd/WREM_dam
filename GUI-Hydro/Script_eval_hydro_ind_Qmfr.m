...
%
% Return the matrix indicatori_medi_Qmfr:
...
indicatori_medi_Qmfr(1:2,1)=[1-mean(indicators_RNA_semifinals);1-(mean(indicators_dif_fraz_CVs_semifinals)/mean(indicators_sum_fraz_CVs_semifinals))];
mem_B1(1)=nanmean(mem_B1).*(giorni_funzionamento-st.days_stop_machines);
indicatori_medi_Qmfr(1:3,1)=[indicatori_medi_Qmfr(1:2,1);mem_B1(1)];
